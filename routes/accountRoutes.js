...
router.post('/login', passport.authenticate('local', {successRedirect: '/account/checkFirstLogin',
failureRedirect: '/account/login?error=tên tài khoản hoặc mật khẩu không chính xác'}));
